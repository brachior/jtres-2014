...
\section{Impl\'ementations des Combinateurs}
  ...
  \subsection{Impl\'ementation g\'en\'erale}
    ...
    \begin{itemize}
      \item a lookup (Lookup) to find the bootstrap method;
      \item a name (String) to know what the bootstrap method have to do;
      \item a type (MethodType) to identify the method;
      \item and other arguments.
    \end{itemize}

    \fixme{MethodHandles.Lookup.PRIVATE ???}
    ...
    The ``invoke'' method need the true signature when we call it,
