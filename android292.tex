...
%       La JSR 292 nécessite que la VM connaisse de nouvelles constantes et de nouvelles instructions.
%       Deux nouvelles entrées dans le constant pool sont donc possibles, celle d'un MT et celle d'un MH.
%       Pour les instructions, une seule a pu être ajoutée, celle d'invoke-dynamic.
%       Cette instruction permet de faire des éditions de liens tardives et de pouvoir modifier ce lien à l'exécution.
%       Lors du premier appel, une méthode d'amorce est appelée, cette dernière peut prendre entre 0 et 251 arguments.
%       La méthode d'amorce s'occupe de créer le site d'appel (l'édition de lien) pour l'appel actuel et ceux futurs.
%       ...
