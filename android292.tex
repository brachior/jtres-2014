...
\section{Overview}
  ...
  \subsection{Java Specification Request 292}
    ...
    \subsubsection{Example}
      ...
      The classes (MethodHandle, MethodType, CallSite, etc.) specified by the \Jsr are grouped into the
      package ``java.lang.invoke'' and are directly understood by the \JVM.
...
\section{Android 292}
  ...
  The section~\ref{implD} describe in detail the most important implementation parts,
  describing how an invokedynamic opcode or a method handle are executed by our modified VM.
